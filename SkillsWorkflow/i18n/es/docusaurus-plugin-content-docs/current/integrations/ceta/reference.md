...
Esta página es la especificación de interfaz de la integración CETA — formatos de archivo, convenciones de nomenclatura y mapeo campo por campo. Está dirigida al equipo que implementa el intercambio.

Para saber qué hace esta integración y cómo se configura, consulte **[CETA](./)**.
:::
