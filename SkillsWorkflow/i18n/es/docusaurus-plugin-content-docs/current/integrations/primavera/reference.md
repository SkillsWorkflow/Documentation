---
title: "Primavera — Referencia Técnica"
sidebar_label: Referencia Técnica
sidebar_position: 2
---
...
:::info Referencia técnica
Esta página es la especificación de interfaz de la integración Primavera — formatos de archivo, convenciones de nomenclatura y mapeo campo por campo. Está dirigida al equipo que implementa el intercambio.

Para saber qué hace esta integración y cómo se configura, consulte **[Primavera](./)**.
:::
