---
id: leave-dashboard
title: Ausências Workspace
sidebar_label: Ausências Workspace
sidebar_position: 6
---
...
Esse Workspace fornece uma visualização de calendário mostrando quais usuários da mesma empresa estão de licença em cada dia útil do mês do calendário.

Para acessar este painel, selecione "Ausências" no menu Workspaces e o calendário do mês atual será exibido.
...
- [Agendamento de Ausências](/docs/product/people/leaves/scheduling-leaves)
