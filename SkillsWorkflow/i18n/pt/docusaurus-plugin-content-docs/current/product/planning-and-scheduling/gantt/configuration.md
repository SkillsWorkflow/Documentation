...
Para construir um planeamento de raiz, consulte [Gantt Chart](using-the-gantt.md) na University.
...
- [Gantt Chart](using-the-gantt.md), construir o planeamento de um projeto no Gantt.
