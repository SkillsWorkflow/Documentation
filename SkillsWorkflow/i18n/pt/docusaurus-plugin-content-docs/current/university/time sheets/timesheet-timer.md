...
O Temporizador de Timesheet permite-lhe registar em tempo real o tempo que dedica a um documento. Inicie um cronómetro quando começar a trabalhar, pause-o quando fizer uma pausa e pare-o quando terminar. O tempo registado pode então ser submetido como uma entrada de timesheet.

:::note
O Temporizador de Timesheet deve ser ativado pelo seu administrador em **System Settings > Behavior > Enable Timesheet Timer**.
:::
...
4. Clique numa das opções para iniciar o temporizador.

## Temporizador em Funcionamento

Assim que o temporizador é iniciado, a barra do menu superior mostra uma **pílula do temporizador** que apresenta o tempo decorrido no formato `HH:MM:SS`.
...
| Elemento | Descrição |
|---|---|
| **Botão de parar** (vermelho) | Para o temporizador e abre o formulário de submissão |
| **Botão de reproduzir** (verde) | Apenas visível quando o temporizador está em pausa — retoma o temporizador |
| **Botão de ir para** | Navega para o documento que está a ser registado |
| **Apresentação do tempo** | Mostra o tempo decorrido. Clique para pausar o temporizador |

Enquanto o temporizador está em funcionamento, o **título do separador do navegador** também se atualiza para mostrar o tempo decorrido e o nome do documento (por exemplo, `⏱ 01:23:45 - O Meu Projeto`).
...
- Para **pausar** o temporizador, clique na apresentação do tempo. O texto do tempo ficará esbatido e aparecerá um indicador de pausa.
...
<figcaption>Formulário de submissão de timesheet após parar o temporizador</figcaption>
</figure>
...
Se iniciar um temporizador enquanto outro já está em funcionamento, aparecerá um diálogo de confirmação pedindo-lhe que escolha:
...
Se o seu temporizador atingir as **8 horas**, o sistema notificá-lo-á com uma notificação do navegador e um diálogo de confirmação na aplicação. Pode optar por continuar o registo ou parar o temporizador.

## Persistência do Temporizador

O estado do seu temporizador é **guardado automaticamente** no servidor. Se fechar o navegador, atualizar a página ou mudar de dispositivo, o seu temporizador retomará de onde ficou quando voltar a iniciar sessão.
