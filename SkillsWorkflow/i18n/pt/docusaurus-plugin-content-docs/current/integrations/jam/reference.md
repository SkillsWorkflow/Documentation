...
Esta página é a especificação de interface da integração JAM — formatos de ficheiro, convenções de nomenclatura e mapeamento campo a campo. Destina-se à equipa que implementa a troca de dados.

Para saber o que esta integração faz e como é configurada, consulte **[JAM](./)**.
:::
