---
title: "Primavera — Referência Técnica"
sidebar_label: Referência Técnica
sidebar_position: 2
---
...
Esta página é a especificação de interface da integração Primavera — formatos de ficheiro, convenções de nomenclatura e mapeamento campo a campo. Destina-se à equipa que implementa a troca de dados.

Para saber o que esta integração faz e como é configurada, consulte **[Primavera](./)**.
:::
