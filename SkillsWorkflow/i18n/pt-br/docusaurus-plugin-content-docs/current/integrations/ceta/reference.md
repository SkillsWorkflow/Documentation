...
Esta página é a especificação de interface da integração CETA — formatos de arquivo, convenções de nomenclatura e mapeamento campo a campo. Destina-se à equipe que implementa a troca de dados.
