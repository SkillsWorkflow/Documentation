...
Para montar um cronograma do zero, consulte [Gantt Chart](using-the-gantt.md) na University.
...
- [Gantt Chart](using-the-gantt.md), montar o cronograma de um projeto no Gantt.
