...
If you need to confirm which stage types are actually being used in your environment, check [`DE-Stages`](../../build-and-extend/api/data-extraction/de-stages.md).
...
- Before creating reports or integrations, confirm the values used in your environment with [`DE-Stages`](../../build-and-extend/api/data-extraction/de-stages.md).
