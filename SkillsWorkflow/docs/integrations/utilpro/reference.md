...
This page is the interface specification for the UtilPro integration — file formats, naming conventions and field-by-field mappings. It is written for the team implementing the exchange.

For what this integration does and how it is configured, see **[UtilPro](./)**.
:::
